...
const end = content.indexOf('// Add this type and these options outside the function');

if (start !== -1 && end !== -1) {
  content = content.substring(0, start) + newModeCard + "\n\n" + content.substring(end);
  fs.writeFileSync(file, content, 'utf8');
  console.log("Fixed ParticipantsEditor.tsx");
} else {
