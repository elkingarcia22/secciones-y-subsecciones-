...
export function RailSelectionChip({
  ...
  return (
    <div className={cn("flex items-center gap-2 px-1", className)}>
      <span className="whitespace-nowrap text-[12.5px] font-semibold text-zinc-100">
      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <button
            ...
            className="flex h-8 w-8 items-center justify-center rounded-xl text-zinc-400 transition-all hover:bg-white/10 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/30 active:scale-95"
          >
