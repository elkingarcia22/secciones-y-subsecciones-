  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
        ...
        <TooltipTrigger asChild>
          <PopoverTrigger asChild>
            <button
              ...
              aria-label={label}
              className={cn(
                "flex h-10 w-10 items-center justify-center rounded-xl text-zinc-400 transition-all hover:bg-white/10 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/30 active:scale-95",
                open && "bg-white/10 text-white"
              )}
            >
              <MoreHorizontal className="h-[20px] w-[20px]" strokeWidth={2.3} />
            </button>
          </PopoverTrigger>
        </TooltipTrigger>
      ...
      <PopoverContent
        ...
        side="top"
        sideOffset={16}
        className="w-[248px] rounded-2xl border-zinc-800/80 bg-zinc-900 p-2 text-zinc-400 shadow-[0_8px_30px_rgb(0,0,0,0.24)]"
      >
              ...
              <span
                className={cn(
                  ...
                  item.tone === "danger"
                    ...
                    : "bg-white/5 text-zinc-400 group-hover:bg-white/10 group-hover:text-white group-disabled:group-hover:bg-white/5"
                )}
              >
                {item.icon}
              </span>
