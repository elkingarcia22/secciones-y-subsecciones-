    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          ...
          disabled={disabled}
          className={cn(
            "flex h-10 w-full items-center justify-between rounded-md border border-border/70 bg-muted px-5 text-sm text-foreground font-medium transition-all hover:bg-muted/60 focus:ring-2 focus:ring-primary/20",
            className
          )}
        >
